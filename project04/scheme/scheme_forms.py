...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        # BEGIN PROBLEM 10
        "*** YOUR CODE HERE ***"
        lambda_prod = do_lambda_form(Pair(signature.rest, expressions.rest), env)
        env.define(signature.first, lambda_prod)
